...
subjects=(BANDA176 BANDA177 BANDA178 BANDA179) #BANDA171 BANDA172 BANDA173 BANDA174 BANDA175) #(BANDA176 BANDA177) # BANDA170) #(BANDA164 BANDA165 BANDA166 BANDA167) # BANDA164) #(BANDA141) #(BANDA163 BANDA164) #(BANDA162) #(BANDA159 BANDA161) #(BANDA129 BANDA137 BANDA151 BANDA153 BANDA154 BANDA155 BANDA157) #(BANDA053) #(BANDA129 BANDA137) #(BANDA148) #(BANDA147 BANDA146) #(BANDA146) #(BANDA143) #(BANDA145) #(BANDA144) #(BANDA141 BANDA142) #(BANDA139 BANDA140 BANDA141) #(BANDA137) #(BANDA135) #(BANDA133)   #(BANDA130 BANDA132) #(BANDA125 BANDA126 BANDA127 BANDA128)  #(BANDA129)   # (BANDA125 BANDA126) #BANDA118 BANDA122 BANDA123 ) #BANDA124 #BANDA122 BANDA123 ) #BANDA120 BANDA121 ) #BANDA119 ) #BANDA118 ) #BANDA107 ) #BANDA111 BANDA112 BANDA113 BANDA114 ) #BANDA103 ) #BANDA083 ) #BANDA101 ) #BANDA103 ) #BANDA095 BANDA097 ) #BANDA092 BANDA093 BANDA094 BANDA095 BANDA096 ) #BANDA089 BANDA090 ) #BANDA080 BANDA081 ) #BANDA075 ) #BANDA066 ) #BANDA065 BANDA064 ) #BANDA063 ) #BANDA062) #BANDA061) #BANDA060 ) #BANDA058 BANDA059 BANDA057) #BANDA056 ) #BANDA057 ) #BANDA056_test ) #BANDA056 ) #BANDA044 BANDA045 BANDA046 BANDA048 BANDA047 BANDA048 BANDA049 BANDA050 BANDA051 BANDA052 BANDA053 BANDA054) #BANDA055 ) #BANDA053 BANDA054 ) #BANDA051 BANDA050_2 BANDA050) #BANDA050 ) #BANDA046 BANDA047 BANDA048 BANDA049 ) #BANDA046 ) #BANDA044 BANDA045 ) #BANDA042 BANDA043) #BANDA037 BANDA038 BANDA039 BANDA040 BANDA041 ) #BANDA043 BANDA042 ) #BANDA041 ) #BANDA040 ) #BANDA039) #BANDA037 BANDA038) #BANDA029 BANDA030 BANDA031 BANDA032 BANDA033 BANDA034 BANDA035 BANDA036 ) #BANDA034 ) #BANDA032 BANDA033 ) #BANDA031 ) #BANDA030 ) #BANDA018 ) #BANDA017 ) #BANDA013)
...
do
	...
	while read scan skip niftyName protocol
		...
		#pbsubmit -n 1 -m jhw30 -c "mri_convert ${folder}/$s/${dicom} ${fout}/${niftyName}.nii.gz "
		pbsubmit -n 1 -m rjj7 -c "mri_convert ${folder}/dicoms/$s/${dicom} ${fout}/${niftyName}.nii.gz "
		#mri_convert ${folder}/dicoms/$s/${dicom} ${fout}/${niftyName}.nii.gz
		#mri_convert ${folder}/$s/${dicom} ${fout}/${niftyName}.nii.gz
...
#:<<ALL_FUNCTIONAL
		...
		pbsubmit -n 1  ${user} -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_gambling1_AP.nii.gz fMRI_SpinEchoFieldMap_PA_3.nii.gz fMRI_SpinEchoFieldMap_AP_3.nii.gz AP"
		pbsubmit -n 1  ${user} -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_gambling2_PA.nii.gz fMRI_SpinEchoFieldMap_PA_3.nii.gz fMRI_SpinEchoFieldMap_AP_3.nii.gz PA"
...
function tractographyAll()
{
	...
	do
		...
		#gqi recon
		${dsistudio}/dsi_studio --action=rec --thread=8 --source=${output}/dwi.src.nii.gz --method=4 --param0=0.5 --odf_order=4 --num_fiber=3 --deconvolution=5
		${dsistudio}/dsi_studio --action=exp  --source=${output}/dwi.src.nii.gz.odf4.f3.de7.rdi.gqi.0.5.fib.gz --export=fa0,gfa
		${dsistudio}/dsi_studio --action=trk --source=${output}/dwi.src.nii.gz.odf4.f3.de7.rdi.gqi.0.5.fib.gz --method=0 --fiber_count=500000 --output=${output}/whole_brain_5k.trk

		gunzip ${output}/whole_brain_5k.trk

		#dti recon
		${dsistudio}/dsi_studio --action=rec --thread=8 --source=${output}/dwi.src.nii.gz --method=1 --param0=0.5 --odf_order=4 --num_fiber=3 --deconvolution=5
		${dsistudio}/dsi_studio --action=exp  --source=${output}/dwi.src.nii.gz.dti.fib.gz --export=fa0,md,rd,ad,

		#/space/erebus/1/users/jwang/jon2/bin/python3 /space/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.ad.nii.gz ${output}/ad.nii.gz
		/space/erebus/1/users/jwang/jon2/bin/python3 /space/erebus/2/users/vsiless/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.ad.nii.gz ${output}/ad.nii.gz

		/space/erebus/1/users/jwang/jon2/bin/python3 /space/erebus/2/users/vsiless/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.rd.nii.gz ${output}/rd.nii.gz
		/space/erebus/1/users/jwang/jon2/bin/python3 /space/erebus/2/users/vsiless/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.fa0.nii.gz ${output}/fa0.nii.gz
		/space/erebus/1/users/jwang/jon2/bin/python3 /space/erebus/2/users/vsiless/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.md.nii.gz ${output}/md.nii.gz

		#register tract
		source ~/fs,jon,bash.sh

		bbregister --s $s --mov /autofs/space/erebus_001/users/data/preprocess/$s/dMRI_topup_eddy.nii.gz --reg /autofs/space/erebus_001/users/data/preprocess/$s/dsi_studio/b02T1.dat --fslmat /autofs/space/erebus_001/users/data/preprocess/$s/dsi_studio/b02T1.mat --dti

		cd /autofs/space/erebus_001/users/data/preprocess/$s/dsi_studio

		dmri_trk2trk --in whole_brain_5k.trk --out streamlines2T1.trk --inref /autofs/space/erebus_001/users/data/preprocess/$s/dMRI_topup_eddy.nii.gz --outref /autofs/space/erebus_001/users/data/preprocess/FS/MGH_HCP/$s/mri/T1.mgz --reg b02T1.mat --fill

		mri_convert --in_type mgz --out_type nii --input_volume /autofs/space/erebus_001/users/data/preprocess/FS/MGH_HCP/$s/mri/T1.mgz --output_volume /autofs/space/erebus_001/users/data/preprocess/$s/dsi_studio/T1.nii.gz

		cd /autofs/space/erebus_001/users/data/preprocess/$s/dsi_studio

		fslswapdim T1.nii.gz LR AP IS T1.nii.gz
		mri_convert --in_orientation LPS T1.nii.gz T1_LPS.nii.gz		

		mkdir /autofs/space/erebus_001/users/data/screenshots_for_participants/${s}_Screenshots
...
#Step 7 (?) - unwarping to correct for gradient non-linearity, following HCP processing protocol
#  Files needed: dMRI_topup_eddy.nii.gz, bvecs and bvals in /preprocess/$subject/
#  Run after eddy!!!

function gradientUnwarping()
{
for s in ${subjects[@]};
do
...
function tractography()
{
	...
	do
		...
		gunzip ${output}/whole_brain_5k.trk
		#dti reconstruction
		${dsistudio}/dsi_studio --action=rec --thread=8 --source=${output}/dwi.src.nii.gz --method=1 --param0=0.5 --odf_order=4 --num_fiber=3 --deconvolution=5 #--output=${output}/fib.gz # --r2_weighted=1  #--
		${dsistudio}/dsi_studio --action=exp  --source=${output}/dwi.src.nii.gz.dti.fib.gz --export=fa0,md,rd,ad,
		/space/erebus/1/users/jwang/jon2/bin/python3 /space/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.ad.nii.gz ${output}/ad.nii.gz
		/space/erebus/1/users/jwang/jon2/bin/python3 /space/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.rd.nii.gz ${output}/rd.nii.gz
		/space/erebus/1/users/jwang/jon2/bin/python3 /space/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.fa0.nii.gz ${output}/fa0.nii.gz
		/space/erebus/1/users/jwang/jon2/bin/python3 /space/rama/2/users/vsiless/scripts/imageUtils.py ${output}/dwi.src.nii.gz.dti.fib.gz.md.nii.gz ${output}/md.nii.gz
...
function AnatomiCuts()
{
	...
	s=$1
		...
		#${filtershortFibers} -i  ${input}//whole_brain_5k_u.trk -o  ${input}/streamlines_long55.trk -t 55
		rm ${output}/*
...
function forAllSubjects()
{
	...
	for (( i=0; i<${num}; i++ ));
	do
		#pbsubmit -n 1 -c "bash ${0} $1 ${subjects[i]}"
		bash ${0} $1 ${subjects[i]}
	done
}
...
:<<NO_LAUNCHPAD
	...
	pbsubmit -n 1 -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_conflict1_AP.nii.gz fMRI_SpinEchoFieldMap_PA_1.nii.gz fMRI_SpinEchoFieldMap_AP_1.nii.gz AP"
	pbsubmit -n 1 -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_conflict2_PA.nii.gz fMRI_SpinEchoFieldMap_PA_1.nii.gz fMRI_SpinEchoFieldMap_AP_1.nii.gz PA"
	pbsubmit -n 1 -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_conflict3_AP.nii.gz fMRI_SpinEchoFieldMap_PA_1.nii.gz fMRI_SpinEchoFieldMap_AP_1.nii.gz AP"
	pbsubmit -n 1 -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_conflict4_PA.nii.gz fMRI_SpinEchoFieldMap_PA_1.nii.gz fMRI_SpinEchoFieldMap_AP_1.nii.gz PA"
...
#:<<DIFFUSION
	...
	fslmerge -t  ${fout}/${study}/dMRI.nii.gz ${fout}/${study}/dMRI_PA.nii.gz ${fout}/${study}/dMRI_AP.nii.gz
	pbsubmit -n 1  -m ${user} jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR dMRI $s dMRI.nii.gz dMRI_AP.nii.gz dMRI_PA.nii.gz AP bvecs bvals"
#DIFFUSION

:<<COM
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR dMRI $s dMRI_PA1.nii.gz dMRI_AP1.nii.gz dMRI_PA1.nii.gz PA dMRI_PA1.bvecs dMRI_PA1.bvals"

	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR dMRI $s dMRI_AP2.nii.gz  dMRI_PA2.nii.gz dMRI_AP2.nii.gz AP dMRI_AP2.bvecs dMRI_AP2.bvals"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR dMRI $s dMRI_PA2.nii.gz  dMRI_PA2.nii.gz dMRI_AP2.nii.gz PA dMRI_PA2.bvecs dMRI_PA2.bvals"
	...
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s fMRI_rest1_AP.nii.gz fMRI_SpinEchoFieldMap_PA.nii.gz fMRI_SpinEchoFieldMap_AP.nii.gz AP"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s fMRI_rest2_PA.nii.gz fMRI_SpinEchoFieldMap_PA.nii.gz fMRI_SpinEchoFieldMap_AP.nii.gz PA"

	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_conflict1_AP.nii.gz fMRI_SpinEchoFieldMap_PA.nii.gz fMRI_SpinEchoFieldMap_AP.nii.gz AP"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_conflict2_PA.nii.gz fMRI_SpinEchoFieldMap_PA.nii.gz fMRI_SpinEchoFieldMap_AP.nii.gz PA"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_conflict3_AP.nii.gz fMRI_SpinEchoFieldMap_PA.nii.gz fMRI_SpinEchoFieldMap_AP.nii.gz AP"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_conflict4_PA.nii.gz fMRI_SpinEchoFieldMap_PA.nii.gz fMRI_SpinEchoFieldMap_AP.nii.gz PA"

	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_faceMatching1_AP.nii.gz fMRI_SpinEchoFieldMap_PA.nii.gz fMRI_SpinEchoFieldMap_AP.nii.gz AP"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 CMRR fMRI $s tfMRI_faceMatching2_PA.nii.gz fMRI_SpinEchoFieldMap_PA.nii.gz fMRI_SpinEchoFieldMap_AP.nii.gz PA"
COM

:<<MGH_HCP

	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 MGH_HCP fMRI $s fMRI_rest1_AP.nii.gz fMRI_DistortionMap_PA.nii.gz fMRI_DistortionMap_AP.nii.gz AP"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 MGH_HCP fMRI $s fMRI_rest2_PA.nii.gz fMRI_DistortionMap_PA.nii.gz fMRI_DistortionMap_AP.nii.gz PA"


	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 MGH_HCP fMRI $s tfMRI_conflict1_AP.nii.gz fMRI_DistortionMap_PA.nii.gz fMRI_DistortionMap_AP.nii.gz AP"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 MGH_HCP fMRI $s tfMRI_conflict2_PA.nii.gz fMRI_DistortionMap_PA.nii.gz fMRI_DistortionMap_AP.nii.gz PA"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 MGH_HCP fMRI $s tfMRI_conflict3_AP.nii.gz fMRI_DistortionMap_PA.nii.gz fMRI_DistortionMap_AP.nii.gz AP"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 MGH_HCP fMRI $s tfMRI_conflict4_PA.nii.gz fMRI_DistortionMap_PA.nii.gz fMRI_DistortionMap_AP.nii.gz PA"

	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 MGH_HCP fMRI $s tfMRI_faceMatching1_AP.nii.gz fMRI_DistortionMap_PA.nii.gz fMRI_DistortionMap_AP.nii.gz AP"
	pbsubmit -n 1  -m jhw30 -c "bash ${scriptFolder}/distortion_v2.sh distortion_CMRR_2 MGH_HCP fMRI $s tfMRI_faceMatching2_PA.nii.gz fMRI_DistortionMap_PA.nii.gz fMRI_DistortionMap_AP.nii.gz PA"
MGH_HCP
...
!<<EDITS
	...
	while read scan skip niftyName protocol
		...
		pbsubmit -n 1 -m jhw30 -c "mri_convert ${folder}/$s/${dicom} ${niftyName}.nii.gz "
	done < $fout/dicom2nifty.csv
...
#	rm ${fout}/CMRR/*
	...
	while read scan skip niftyName protocol
		...
		echo ${dicom}
		#mri_convert ${folder}/$s/${dicom} ${output}/${niftyName}.nii.gz
		pbsubmit -n 1 -m jhw30 -c "mri_convert ${folder}/$s/${dicom} ${output}/${niftyName}.nii.gz "
	done < $fout/dicom2nifty.csv
...
#	rm ${fout}/CMRR/*
	for i in `seq 0 ${#scanNames[@]}`;
		...
		pbsubmit -n 1   -m jhw30 -c "mri_convert ${folder}/$s/${scan} ${output}/${niftyNames[$i]}.nii.gz"
	done
	chgrp -R fiber  ${folder}/preprocess/${s}
	chmod -R 770  ${folder}/preprocess/${s}
