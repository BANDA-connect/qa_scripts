...
def aparc_measures():
	...
	outliers=["BANDA104","BANDA131","BANDA134","BANDA129","BANDA141","BANDA142","BANDA143"] #,"BANDA144","BANDA145"]#["BANDA071", "BANDA070","BANDA005","BANDA045"]
	...
	for measurement in (['thickness','volume']):
		...
		output=csv.writer(open('/space/erebus/1/users/data/scores/new/aparc_output_'+measurement+'_091018.csv','w+'))		
		...
		for key, score in scores.items():
			...
			f.savefig("/space/erebus/1/users/data/scores/new/plots/aparc_"+measurement+"_"+str(key),dpi=199)	
