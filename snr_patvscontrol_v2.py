...
outliers = ["BANDA051","BANDA103","BANDA141","BANDA142","BANDA143"]

def snr():
	output=csv.writer(open('/space/erebus/1/users/data/scores/new/snr_output_subj1,140.csv','w+'))
	...
	#f.savefig("/space/erebus/1/users/data/scores/new/plots/snr_subj1,140",dpi=199)
def plotSNRPerScan():
	snr_perScan=dict()
	subjects, subjects_lbl = utils.getBandaDiagnosis(outliers)
	with open('/space/erebus/1/users/data/scores/new/snr_output_subj1,140.csv', 'r') as csvfile:
...
def plotSNRAvg():
	...
	f.savefig("/space/erebus/1/users/data/scores/new/plots/snrAvg_subj1,140",dpi=199)
	plt.show()
