...
def vNavRead():
	...
	subjects =  ["BANDA120","BANDA121","BANDA122","BANDA123","BANDA124","BANDA125","BANDA126","BANDA127","BANDA128","BANDA129","BANDA130","BANDA132","BANDA133","BANDA135","BANDA136","BANDA137","BANDA138"] 
...
def plotWithinScanMotion():
	#output=csv.writer(open('/space/erebus/1/users/data/scores/motion_within_scan_output.csv','w+'))
	output=csv.writer(open('/space/erebus/1/users/data/scores/tmp/motion_within_scan_output_newtest.csv','w+'))
			...
			for s_index,s in enumerate(subjects):				
				...
				if f != None : 
					...
					if s in control_subjects:
						axarr[i,j].plot(subjects.index(s)+1, t, "o", c='r')
					elif s in anx_subjects:
						axarr[i,j].plot(subjects.index(s)+1, t, "o", c='c')
					elif s in dep_and_anx_subjects:
						axarr[i,j].plot(subjects.index(s)+1, t, "o", c='m')
					elif s in dep_subjects:
						axarr[i,j].plot(subjects.index(s)+1, t, "o", c='y')
...
subjects = [ "BANDA001","BANDA002","BANDA003","BANDA004","BANDA005","BANDA006","BANDA007","BANDA008","BANDA009","BANDA010",
			 "BANDA011","BANDA012","BANDA013","BANDA014","BANDA015","BANDA016","BANDA017","BANDA018","BANDA019","BANDA020",
			 "BANDA021","BANDA022","BANDA023","BANDA024","BANDA025","BANDA026","BANDA027","BANDA028","BANDA029","BANDA030",
			 "BANDA031","BANDA032","BANDA033","BANDA034","BANDA035","BANDA036","BANDA037","BANDA038","BANDA039","BANDA040",
			 "BANDA041","BANDA042","BANDA043","BANDA044","BANDA045","BANDA046","BANDA047","BANDA048","BANDA049","BANDA050",
			 "BANDA051","BANDA052","BANDA053","BANDA054","BANDA055","BANDA056","BANDA057","BANDA058","BANDA059","BANDA060",
			 "BANDA061","BANDA062","BANDA063","BANDA064","BANDA065","BANDA066","BANDA067","BANDA068","BANDA069","BANDA070",
			 "BANDA071","BANDA072","BANDA073","BANDA074","BANDA075","BANDA076","BANDA077","BANDA078","BANDA079","BANDA080",
			 "BANDA081","BANDA082","BANDA083","BANDA084","BANDA085","BANDA086","BANDA087","BANDA088","BANDA089","BANDA090",
			 "BANDA091","BANDA092","BANDA093","BANDA094","BANDA095","BANDA096","BANDA097","BANDA098","BANDA099","BANDA100",
			 "BANDA101","BANDA102","BANDA103","BANDA104","BANDA105","BANDA106","BANDA107","BANDA108","BANDA109","BANDA110",
			 "BANDA111","BANDA112","BANDA113","BANDA114","BANDA115","BANDA116","BANDA117","BANDA118","BANDA119","BANDA120",
			 "BANDA121","BANDA122","BANDA123","BANDA124","BANDA125","BANDA126","BANDA127","BANDA128","BANDA129","BANDA130",
			 "BANDA131","BANDA132","BANDA133","BANDA134","BANDA135","BANDA136","BANDA137","BANDA138","BANDA139","BANDA140"]

control_subjects = [ "BANDA001","BANDA002","BANDA003","BANDA004","BANDA005","BANDA007","BANDA008","BANDA009","BANDA010",
					 "BANDA011","BANDA012","BANDA013","BANDA014","BANDA016","BANDA018","BANDA031","BANDA032","BANDA033",
					 "BANDA034","BANDA035","BANDA036","BANDA038","BANDA039","BANDA040","BANDA041","BANDA042","BANDA043",
					 "BANDA046","BANDA047","BANDA048","BANDA049","BANDA050","BANDA051","BANDA052","BANDA054","BANDA055",
					 "BANDA056","BANDA058","BANDA059","BANDA060","BANDA061","BANDA063","BANDA064","BANDA065","BANDA067",
					 "BANDA068","BANDA069","BANDA070","BANDA071","BANDA072","BANDA075","BANDA076","BANDA077","BANDA078",
					 "BANDA079","BANDA082","BANDA083","BANDA084","BANDA087","BANDA088","BANDA089","BANDA090","BANDA091",
					 "BANDA094","BANDA097","BANDA102","BANDA105","BANDA107","BANDA108","BANDA109","BANDA117","BANDA119",
					 "BANDA122","BANDA124","BANDA126","BANDA128","BANDA133","BANDA136","BANDA139",
					 "BANDA140"]

dep_subjects = ["BANDA024","BANDA047","BANDA068","BANDA077","BANDA082","BANDA086","BANDA090","BANDA099","BANDA110"]

anx_subjects = ["BANDA017","BANDA021","BANDA022","BANDA023","BANDA025","BANDA026","BANDA027","BANDA031","BANDA032","BANDA035",
				"BANDA036","BANDA039","BANDA040","BANDA041","BANDA042","BANDA048","BANDA049","BANDA052","BANDA055","BANDA056",
				"BANDA060","BANDA063","BANDA064","BANDA065","BANDA069","BANDA070","BANDA075","BANDA076","BANDA088","BANDA089",
				"BANDA091","BANDA092","BANDA093","BANDA095","BANDA096","BANDA098","BANDA100","BANDA101","BANDA104","BANDA106",
				"BANDA111","BANDA112","BANDA113","BANDA114","BANDA115","BANDA116","BANDA121","BANDA123","BANDA127","BANDA129",
				"BANDA130","BANDA135","BANDA137","BANDA138"]

dep_and_anx_subjects = ["BANDA006","BANDA015","BANDA019","BANDA020","BANDA028","BANDA029","BANDA030","BANDA037","BANDA044","BANDA045",
						"BANDA053","BANDA057","BANDA062","BANDA066","BANDA073","BANDA074","BANDA080","BANDA081","BANDA085","BANDA103",
						"BANDA118","BANDA120","BANDA125","BANDA132"]
